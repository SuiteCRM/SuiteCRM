...
You may also be interested in [SuiteCRM 8](https://github.com/SuiteCRM/SuiteCRM-Core), the latest version of SuiteCRM. At the time of writing, SuiteCRM 8 is in the levelling-up phase and is not yet feature-complete. More information is available on the [SuiteCRM Journey ](https://suitecrm.com/the-suitecrm-8-journey/).
...
Please see our [Compatibility Matrix](https://docs.suitecrm.com/admin/compatibility-matrix/) and [Installation Guide](https://docs.suitecrm.com/admin/installation-guide/downloading-installing/) for more details.

SuiteCRM Ltd, the authors and maintainers of SuiteCRM, offer a range of [fully managed hosting](https://suitecrm.com/suitecrmhosted/) services. These are ideal for organisations that don't have the in-house knowledge or experience to host and maintain the application, and are a great way to support the future development of the project.
...
To benefit from the latest security and bugfixes as well as the most comprehensive feature set, we recommend all users upgrade to the latest ESR release at their earliest opportunity. See our [upgrade documentation](https://docs.suitecrm.com/admin/installation-guide/upgrading/) for more details.
