...
$mod_strings = array (
  ...
  'LBL_ANALYTICS_SUBMISSIONS' => 'Respostas válidas',
  'LBL_ANALYTICS_SPAM' => 'Spam detectado',
  'LBL_ANALYTICS_REFERRERS' => 'Fontes de tráfico (dominios)',

  // -- WIZARD --
  // Main actions
  'LBL_WIZARD_PREVIOUS' => '<< Anterior',
  'LBL_WIZARD_NEXT' => 'Seguinte >>',
  'LBL_WIZARD_FINISH' => 'Finalizar',
  'LBL_WIZARD_SAVE' => 'Gardar',
  'LBL_WIZARD_SAVED_DRAFT' => 'Formulario gardado',
  'LBL_WIZARD_SHOW_DEBUG_INFO' => 'Mostrar Detalles',

  // Edit Warning
  'LBL_WIZARD_FORM_EDIT_WARNING_TITLE' => '⚠️ ¡Precaución ao editar!',
  'LBL_WIZARD_FORM_EDIT_WARNING_PUBLIC' => 'Este formulario é público: alguén podería estar reenchéndoo neste mesmo momento.',
  'LBL_WIZARD_FORM_EDIT_WARNING_RESPONSES' => 'Hai %s respostas rexistradas: cambiar a estrutura do formulario podería causar inconsistencias.',
  'LBL_WIZARD_FORM_EDIT_WARNING_PROCEED' => 'En caso de querer realizar cambios significativos recoméndase valorar a posibilidade de duplicar o formulario.',

  // Corrupted form warning
  'LBL_WIZARD_FORM_CORRUPTED_WARNING_MESSAGE' => '⚠️ Erro crítico: Non se puido cargar a configuración correctamente. O formulario mostrarase baleiro e o gardado automático desactivouse para evitar a perda de datos.',
  
  // Steps
  'LBL_WIZARD_TITLE_STEP1' => 'Información Xeral',
  'LBL_WIZARD_DESC_STEP1' => 'Definición das propiedades xerais do formulario.',
  'LBL_WIZARD_TITLE_STEP2' => 'Estrutura e campos',
  'LBL_WIZARD_DESC_STEP2' => 'Definición do contido do formulario. Os bloques de datos poden vincularse a módulos de SinergiaCRM ou funcionar de forma independente. Ademais, é posible configurar validacións de datos, detección de duplicados, etc.',
  'LBL_WIZARD_TITLE_STEP2_START' => 'Empiece a construir el formulario',
  'LBL_WIZARD_TITLE_STEP3' => 'Lóxica e automatismos',
  'LBL_WIZARD_DESC_STEP3' => 'Definición das accións que se executarán cando se reciba unha resposta: crear ou actualizar rexistros, enviar correos electrónicos, redireccionar a páxinas web, etc.',
  'LBL_WIZARD_TITLE_STEP4' => 'Maquetación',
  'LBL_WIZARD_DESC_STEP4' => 'Deseño da aparencia do formulario. Permite definir o estilo visual, organizar os bloques de datos, personalizar a cabeceira e o pé do formulario, etc.',
  'LBL_WIZARD_TITLE_STEP5' => 'Resumo e publicación',
  'LBL_WIZARD_DESC_STEP5' => 'Revisión e activación do formulario. Permite activar a recepción de respostas, obter a ligazón de acceso público ou descargar o código HTML para integralo nunha páxina web externa.',
  ...
  'LBL_BUTTON_MOVE_DOWN' => 'Mover abaixo',
  ...
  'LBL_SELECT_WRITE_TO_SEARCH' => 'Escriba para filtrar a lista...',
  'LBL_SELECT_NO_RESULTS' => 'Non existen coincidencias',

  // DataBlocks
  'LBL_DATABLOCK' => 'Bloque de datos',
  'LBL_DATABLOCKS' => 'Bloque de datos',
  'LBL_DATABLOCK_DETACHED' => 'Datos non enlazados',
  'LBL_DATABLOCK_ADD' => 'Engadir un bloque de datos',
  ...
  'LBL_FIELDS_FORM_TAB_DESC' => 'Campos que se incluirán no formulario público.',
  'LBL_FIELDS_FIXED_TAB' => 'Servidor',
  'LBL_FIELDS_FIXED_TAB_DESC' => 'Campos con valor prefixado que se incorporarán aos datos recibidos dos formularios.',
  'LBL_FIELD_FORM' => 'Campo no formulario',
  'LBL_FIELD_FORM_ADD' => 'Engadir campo',
  'LBL_FIELD_FORM_NEW' => 'Novo Campo',
  'LBL_FIELD_UNLINKED' => 'Campo non enlazado',
  'LBL_FIELD_UNLINKED_ADD' => 'Engadir campo non enlazado',
  'LBL_FIELD_UNLINKED_NEW' => 'Novo campo non enlazado',
  'LBL_FIELD_FIXED' => 'Valor Fixo',
  'LBL_FIELD_FIXED_ADD' => 'Engadir campo de servidor',
  'LBL_FIELD_FIXED_NEW' => 'Novo campo de servidor',
  'LBL_FIELD_CONVERT_TO_FIELD_FORM' => 'Converter en campo de formulario',
  'LBL_FIELD_CONVERT_TO_FIELD_FIXED' => 'Converter en campo de servidor',
  ...
  'LBL_FIELD' => 'Campo',
  'LBL_FIELD_NAME' => 'Nome',
  'LBL_FIELD_INTERNAL_NAME' => 'Nome interno',
  'LBL_FIELDS_SHOW_ALL' => 'Mostrar Todos os Campos',
  'LBL_FIELDS_SHOW_ALL_DESC' => 'Incluír no despregable todos os campos do módulo aínda que non se mostren nas vistas de edición ou detalle.',
  'LBL_FIELD_LABEL' => 'Etiqueta',
  'LBL_FIELD_REQUIRED_IN_FORM' => 'Campo obrigatorio ',
  'LBL_FIELD_IN_FORM' => 'No Formulario',
  'LBL_FIELD_TYPE_IN_FORM' => 'Tipo de entrada',
  'LBL_FIELD_SUBTYPE_IN_FORM' => 'Tipo de editor',
  'LBL_FIELD_PLACEHOLDER' => 'Texto de fondo',
  'LBL_FIELD_DESCRIPTION' => 'Texto de Axuda',
  'LBL_FIELD_ADD_LINK' => 'Engadir enlace',
  'LBL_FIELD_LINK_CREATE' => 'Crear enlace',
  'LBL_FIELD_LINK_TEXT' => 'Texto do enlace',
  'LBL_FIELD_LINK_URL' => 'URL de destino',
  'LBL_FIELD_VALUE_TYPE' => 'Tipo de valor',
  'LBL_FIELD_VALUE_OPTIONS_LIST' => 'Lista asociada',
  'LBL_FIELD_VALUE_OPTIONS_CUSTOMIZE' => 'Personalizar opcións',
  ...
  'LBL_FIELD_VALUE_OPTION_ACTIONS' => 'Accións',
  'LBL_FIELD_VALUE' => 'Valor',
  'LBL_FIELD_VALUE_RELATIVE_DATE_OPTION' => 'Data relativa',
  'LBL_FIELD_VALUE_RELATIVE_DATE_OPTION_DESC' => 'Permite indicar unha data relativa á data das respostas recibidas.',
  'LBL_FIELD_VALUE_RELATIVE_DATE_CUSTOM' => 'Data relativa personalizada',
  'LBL_FIELD_VALUE_RELATIVE_DATE_CUSTOM_DESC' => 'Expresión en inglés compatible ca función strtotime() de PHP. Exemplos: tomorrow 14:00, next monday, +2 weeks, first day of next month.',
  'LBL_FIELD_ACTIONS' => 'Accións',
  
  // DataBlock -> Field -> Validations
  'LBL_FIELD_VALIDATION' => 'Validación',
  'LBL_FIELD_VALIDATOR' => 'Acción de validación',
  'LBL_FIELD_VALIDATION_ADD' => 'Engadir validación',
  'LBL_FIELD_VALIDATION_NEW' => 'Nova validación',
  'LBL_FIELD_VALIDATION_EDIT' => 'Editar validación',
  'LBL_FIELD_VALIDATION_PARAMETERS' => 'Parámetros',
  'LBL_FIELD_VALIDATION_ERROR_MESSAGE' => 'Mensaxe de erro',
  'LBL_FIELD_VALIDATION_ACTIONS' => 'Accións',
  'LBL_FIELD_ACTIVE_VALIDATIONS' => 'Validacións activas',

  // DataBlock -> Duplicate checks
  'LBL_DUPLICATE_CHECK' => 'Detección de Duplicados',
  'LBL_DUPLICATE_CHECK_ADD' => 'Engadir detección de duplicados',
  ...
  'LBL_RELATIONSHIPS' => 'Relacións entre bloques de datos',
  'LBL_RELATIONSHIP_ADD' => 'Engadir relación',
  ...
  // Flow -> Action
  'LBL_ACTION' => 'Acción',
  'LBL_ACTION_ADD' => 'Engadir acción',
  'LBL_ACTION_NEW' => 'Nova acción',
  'LBL_ACTION_TERMINAL' => 'Acción final',
  'LBL_ACTION_TERMINAL_ADD' => 'Engadir acción final',
  'LBL_ACTION_TERMINAL_NEW' => 'Nova acción final',
  'LBL_ACTION_SELECT' => 'Seleccionar Acción',
  'LBL_ACTION_TO_VIEW_DETAILS' => 'Seleccione unha acción para ver os seus detalles.',
  'LBL_ACTION_CONTINUE' => 'Continuar',
  'LBL_ACTION_BACK' => 'Atrás',
  'LBL_ACTION_NAME' => 'Nome',
  ...
  'LBL_ACTION_PARAM_MISSING_MESSAGE' => 'Hai parámetros obrigatorios sen valor. Revise a configuración da acción e asigne valores aos parámetros requiridos antes de gardar.',
  'LBL_ACTION_CONDITION_TEXT' => 'Esta acción só se executará se se cumpre a condición.',
  'LBL_ACTION_CONTINUE_ON_ERROR' => 'Continuar en caso de error',
  'LBL_ACTION_CONTINUE_ON_ERROR_DESC' => 'Se se activa, o fluxo continuará incluso se a acción erra.',

  // Conditions (Datablock field validations & Actions)
  'LBL_CONDITION' => 'Condición para a execución',
  'LBL_CONDITION_SUMMARY' => 'Condición',
  'LBL_APPLY_CONDITION' => 'Condicionar ao valor doutro campo',
  ...
  'LBL_THEME_FIELDS_LABELS' => 'Campos e etiquetas',
  'LBL_THEME_BORDERS' => 'Bordes e sombras',
  'LBL_THEME_BORDER_RADIUS_CONTAINER' => 'Redondeo (caixas)',
  'LBL_THEME_BORDER_RADIUS_CONTROLS' => 'Redondeo (botóns/controis)',
  'LBL_THEME_BORDER_WIDTH' => 'Ancho do borde',
  'LBL_THEME_BORDER_COLOR' => 'Color do borde',
  'LBL_THEME_FLOATING_LABELS' => 'Etiquetas flotantes',
  'LBL_THEME_FLOATING_LABELS_DESC' => 'Se se activa, as etiquetas colócanse dentro dos campos e moveranse ao escribir.',
  ...
  'LBL_THEME_STRUCTURE' => 'Estrutura e distribución',
  'LBL_THEME_FORM_WIDTH' => 'Ancho máximo',
  'LBL_THEME_FIELD_SPACING' => 'Espaciado entre campos',
  'LBL_THEME_SUBMIT_FULL_WIDTH' => 'Ancho completo do botón de envío',
  'LBL_THEME_EQUAL_HEIGHT_SECTIONS' => 'Igualar altura de seccións',
  'LBL_THEME_SECTIONS_PER_ROW' => 'Columnas (seccións)',
  'LBL_THEME_FIELDS_PER_ROW' => 'Columnas (campos)',
  'LBL_THEME_PER_ROW_DESC' => 'O número de columnas adaptarase automaticamente ao ancho da pantalla.',
  'LBL_THEME_ADVANCED' => 'Avanzado',
  'LBL_THEME_ADVANCED_NO_ADMIN_DESC' => 'A configuración avanzada (CSS e JS) está restrinxida a usuarios administradores.',
  'LBL_THEME_CUSTOM_CSS' => 'Css personalizado',
  'LBL_THEME_CUSTOM_CSS_DESC' => 'Inxectarase nun bloque <style>.',
  'LBL_THEME_CUSTOM_JS' => 'Js personalizado',
  'LBL_THEME_CUSTOM_JS_DESC' => 'Procesarase cando todo o formulario estea cargado.',
  
  'LBL_THEME_CLOSED_FORM' => 'Aviso: Formulario cerrado',
  'LBL_THEME_CLOSED_FORM_DESC' => 'Aviso que aparecerá no formulario cando xa non acepte respostas.',
  ...
  'LBL_THEME_CLOSED_FORM_TEXT_VALUE' => 'Este formulario non acepta respostas.',

  'LBL_THEME_PROCESSED_FORM' => 'Mensaxe: Datos procesados',
  ...
  'LBL_THEME_RECEIPT_FORM_TEXT_VALUE' => 'Os seus datos foron recibidos correctamente e serán procesados o antes posible.',
  ...
  'LBL_CODE_GENERATING_ERROR' => 'Erro xerando o código',
  ...
  'LBL_PREVIEW_LOAD_ERROR' => 'Erro cargando a previsualización',
  'LBL_PREVIEW_DESC' => 'Visualización real xerada polo servidor.',
  'LBL_PREVIEW_MODE_ALERT' => 'O formulario está en modo previsualización. Non está activado o envío de datos.',
  'LBL_PREVIEW_TOOLBAR' => 'Previsualización',
  'LBL_PREVIEW_ACTIVE_TEXT' => 'Activo',
  'LBL_PREVIEW_INACTIVE_TEXT' => 'Inactivo',
  'LBL_PREVIEW_IN_NEW_TAB' => 'Previsualizar en pestana nova',

  'LBL_FORM_PUBLISH_OPTIONS' => 'Opcións de publicación',
  'LBL_FORM_PUBLISH_LINK' => 'Enlace único',
  'LBL_FORM_PUBLISH_LINK_DESC' => 'Copie e comparta este enlace para acceder ao formulario.',
